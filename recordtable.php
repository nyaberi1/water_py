...
<head>
  <title>ESP8266 RECORD TABLE</title>
...
<body>
  ...
  <table class="styled-table" id="table_id">
    ...
    <tbody id="tbody_table_record">
      ...
      $sql = 'SELECT * FROM dht11 ORDER BY datetime';
      foreach ($pdo->query($sql) as $row) {
        ...
        echo '<td class="bdr">' . $row['moisture'] . '</td>';
        echo '<td class="bdr">' . $row['status_read_sensor_dht11'] . '</td>';
        echo '<td class="bdr">' . $row['datetime'] . '</td>';
