...
const char* ssid = "vendor";
const char* password = "pny@123.";
//
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin(client, "http://192.168.1.192/water_py/updateDHT11data_and_recordtable.php");  //--> Specify request destination
